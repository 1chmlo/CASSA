...
def verify_plate(image_data):
    ...
    # Si no se detectó ninguna matrícula, usa la imagen original
    if matricula_recortada is None:
        matricula_recortada = image

    # Convierte la imagen (recortada o original) a RGB
