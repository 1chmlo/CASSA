...
const LineChartNoPermitido = () => {
  ...
  const midata = {
    ...
    datasets: [
      {
        label: "Ingresos No Permitidos",
        data: ingresos,
        tension: 0.5,
        fill: true,
        borderColor: "rgb(255, 99, 132)", // Color de borde rojo
        backgroundColor: "rgba(255, 99, 132, 0.2)", // Color de fondo rojo con transparencia
        pointRadius: 5,
        pointBorderColor: "rgba(255, 99, 132)", // Color de borde de los puntos rojo
        pointBackgroundColor: "rgba(255, 99, 132)", // Color de fondo de los puntos rojo
      },
    ],
  };
...
export default LineChartNoPermitido;
