...
function Agregarvisitas() {
  ...
  <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Agenda tu visita</h2>
  <p class="mt-2 text-lg leading-8 text-gray-600">
    Introduce los datos de tu visita en el formulario siguiente.
  </p>
</div>
            ...
            <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                    ...
                    <div className="sm:col-span-2">
                        <label htmlFor="company" className="block text-sm font-semibold leading-6 text-gray-900">Rut</label>
                        <div className="mt-2.5">
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-2.5">
                            <input type="Fecha" name="Fecha" id="Fecha" autoComplete="Fecha" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                        </div>
                    </div>
                    <div className="sm:col-span-2">
                        <label htmlFor="tipodev" className="block text-sm font-semibold leading-6 text-gray-900">Tipo de visita</label>
                        <div className="relative mt-2.5">
                            <input type="tipodev" name="tipodev" id="tipodev" autoComplete="tipodev" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                        </div>
                    </div>
                    <div className="sm:col-span-2">
                        <label htmlFor="message" className="block text-sm font-semibold leading-6 text-gray-900">Comentario(opcional)</label>
                        <div className="mt-2.5">
                ...
                <div className="mt-10">
                    <button type="submit" className="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-indigo-600">Registrar Visita</button>
                </div>
            </form>
        </div>
    );
